...
<html>
  ...
  <body>
    ...
    <section class = "about container">
      ...
      <div class = "row">
        <div class = "row-left">
          <img src = "assets/na.png" alt = "about photo" style="border-radius: 20px;">
        </div>

        <div class = "row-right">
          <p class = "text">
            - I am a junior web developer and programmer,
            I am 23 years old,
            I studied at Damascus University for two years
            in and I graduated and obtained a technical diploma in computer engineering
            with a specialization in software engineering
            with an (GPA: 3.41/4.0).      
          ...
          <div class = "about-content">
            <ul>
              ...
              <li class = "text">
                <span>Email: </span>
                <span>nadim.alzoubi.99@gmail.com</span>
              </li>
              <!-- <li class = "text">
                <span>Zip code: </span>
                <span>758844</span>
              ...
              <li class = "text">
                <span>Phone: </span>
                <span>+971 50 443 0587</span>
              </li>
              <li class = "text">
                <span>Address: </span>
                <span>Al Ghais Street. Alkhalidiya, Abu Dhabi, UAE</span>
              </li>
            </ul>
          </div>
          <!-- <h3>120 <span>Project complete</span></h3> -->
          <a href="./assets/Nadim Al-Zoubi-279.pdf" class = "btn" style="color: #111;" download>download cv</a>
          <span style="margin: 0 1.5rem;"> OR </span>
          <a href="./assets/Nadim Al-Zoubi-279.pdf" class = "btn" style="color: #111;">view cv</a>
        </div>
      </div>
    </section>
    <!-- end of about page -->
