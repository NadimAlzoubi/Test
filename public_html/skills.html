...
<html>
  ...
  <body>
    ...
    <section class = "skills container">
      ...
      <p class = "text">These are my basic skills that I can work on in the filed of computer, web development and design.</p>

      <div>
        <h2 style="text-align: center; font-size:xxx-large;">Basic Skills</h2>
      </div>
      ...
      <div class = "row">
        <div class = "item">
          <div class = "item-text">
            <span>Using Computer</span>
            <span class = "w-95">100%</span>
          </div>
          <div class = "progress">
        ...
        <div class = "item">
          <div class = "item-text">
            <span>Fast Typing On Keyboard</span>
            <span class = "w-85">35WPM</span>
          </div>
          <div class = "progress">
            <div class = "progress-bar w-85"></div>
          </div>
      ...
      <div style="margin-top: 5rem;">
        <h2 style="text-align: center; font-size:xxx-large;">Programming & Design Skills</h2>
      </div>
